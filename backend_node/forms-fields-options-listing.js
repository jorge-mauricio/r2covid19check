                                    ...
                                    <tr class="ss-backend-table-bg-light">
                                        ...
                                        <td style="text-align: center;">
                                            ...
                                            `
                                                ...
                                                `
                                                    <img src="${ gSystemConfig.configSystemURLImages + gSystemConfig.configDirectoryFilesSD + "/t" + formsFieldsOptionsRow.image_main + "?v=" + this.cacheClear }" alt="${ SyncSystemNS.FunctionsGeneric.contentMaskRead(formsFieldsOptionsRow.option_name, "db") }" class="ss-backend-images-listing" />
                                                ` : ``
                                                }
                                                ...
                                                `
                                                    <a href="${ gSystemConfig.configSystemURLImages + gSystemConfig.configDirectoryFilesSD + "/g" + formsFieldsOptionsRow.image_main + "?v=" + this.cacheClear }"
                                                       title="${ SyncSystemNS.FunctionsGeneric.contentMaskRead(formsFieldsOptionsRow.option_name, "db") }"
                                                       class="glightbox_categories_image_main${ formsFieldsOptionsRow.id }"
                                                       data-glightbox="title:${ SyncSystemNS.FunctionsGeneric.contentMaskRead(formsFieldsOptionsRow.option_name, "db") };">
